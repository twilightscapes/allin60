...
<div className='player-wrapper' style={{position:'relative', width:'100vw',  top:'', zIndex:'', height:'content-fill', overflow:'hidden' }}>
...
<div className="" style={{display:'block', justifyContent:'', maxWidth:'60vw', margin:'', flexDirection:'', border:'0px solid red', position:'relative', top:'0', height:''}}>
